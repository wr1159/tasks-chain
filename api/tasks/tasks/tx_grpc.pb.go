...
const (
	Msg_UpdateParams_FullMethodName = "/tasks.tasks.Msg/UpdateParams"
	Msg_CreateTask_FullMethodName   = "/tasks.tasks.Msg/CreateTask"
	Msg_UpdateTask_FullMethodName   = "/tasks.tasks.Msg/UpdateTask"
	Msg_DeleteTask_FullMethodName   = "/tasks.tasks.Msg/DeleteTask"
)
